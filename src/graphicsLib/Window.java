package graphicsLib;
  ...
  //Window class created itself as those three listeners
  //registered itself at all the proper places to get those calls
  //implemented all those mouse and keyboard listening functions
  //and does NOTHING with any of them
